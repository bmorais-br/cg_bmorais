/*
  ...
  Scope: Performance tab only — merchandising health not exposed in Competitors tab.
  Cohort: dealers who clicked the MerchandisingRecommendation QuickAction. Proxy for "saw the gap
    and engaged." Note: cohort is thin (~7 dealers as of Aug 2026) — treat results as directional.
...
, first_ci_performance_views as (
    -- Dealers who clicked MerchandisingRecommendation QuickAction in Performance tab.
    select
        service_provider_id
